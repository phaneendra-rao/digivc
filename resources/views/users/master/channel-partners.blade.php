                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <i class="icofont icofont-users-alt-2 bg-c-green"></i>
                                <div class="d-inline">
                                    <h4>All Channel Partners</h4>
                                    <span style="text-transform:none;">You can manage all channel partners</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{url('/')}}/{{auth()->user()->account_type}}/channel-partners">Channel Partners</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-header card">
                                <ul class="nav nav-tabs md-tabs nav-justified tab-timeline" role="tablist" id="mytab">
                                    <li class="nav-item">
                                        <a class="nav-link inner_tabs active" style="cursor:pointer;" id="channel_partners" role="tab">Channel Partners</a>
                                        <div class="slide"></div>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link inner_tabs" style="cursor:pointer;" id="add_new_channel_partner" role="tab">Add New Channel Partner</a>
                                        <div class="slide"></div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane inner_tabs_open active" id="channel_partners_open" role="tabpanel">
                                    <div class="card">
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="data_table_main table-responsive dt-responsive">
                                                        <table id="channel_partners_table" style="width:100%;" class="table table-striped table-bordered nowrap">
                                                            <thead>
                                                                <tr>
                                                                    <th>Sno</th>
                                                                    <th>Channel Partner Info</th>
                                                                    <th>Users</th>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane inner_tabs_open d-none" id="add_new_channel_partner_open" role="tabpanel">
                                    <div class="card">
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <form id="channel_partner_form" autocomplete="off">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Top-up Credits</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="top_up_credits" id="top_up_credits" class="form-control number" placeholder="Top Up Credits (eg: ₹ 10,000)">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
...
<script>
    ...
    var channel_partners_table = $('#channel_partners_table').DataTable({

        processing: true,
        stateSave: true,
        serverSide: true,
        ajax: {
            url: "{{url('/')}}/{{auth()->user()->account_type}}/get_all_channel_partners",
            dataType: "json",
            type: "POST",
            data: {
                _token: "{{csrf_token()}}"
    ...
    $('#add_user_btn,#update_user_btn').click(() => {
        if (iti.isValidNumber()) {
            if (iti.getNumberType() === intlTelInputUtils.numberType.MOBILE) {
                $.ajax({
                    url: "{{url('/')}}/{{auth()->user()->account_type}}/add_update_channel_partner",
                    method: "POST",
                    data: new FormData($('#channel_partner_form')[0]),
                    dataType: 'JSON',
                    contentType: false,
                    cache: false,
                    processData: false,
                    ...
                    success: (data) => {
                        ...
                        if (data.status == 'Success') {
                            ...
                            channel_partners_table.draw(false);
    ...
    function change_channel_partner_status(user_id, status) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{url('/')}}/{{auth()->user()->account_type}}/change_channel_partner_status",
                    data: {
                        user_id: user_id,
                        status: status
                    },
    ...
    function delete_channel_partner(user_id) {
        Swal.fire({
            title: 'Are you sure!',
            ...
            if (result.value) {
                $.ajax({
                    url: "{{url('/')}}/{{auth()->user()->account_type}}/delete_channel_partner",
                    data: {
                        user_id: user_id
                    },
                    method: "POST",
