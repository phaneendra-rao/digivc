...
<script>
    ...
    $('#add-product-submit').click(() => {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/add_card_product",
            method: "POST",
    ...
    $('#update-product-submit').click(() => {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/update_card_product",
            method: "POST",
            data: new FormData($('#products_form')[0]),
            dataType: 'JSON',
            contentType: false,
    ...
    function edit_product(id) {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/get_card_product",
            method: "GET",
            data: {
                id: id
            },
    ...
    function delete_product(id) {
        if (confirm('Are you sure ? you want to delete the product')) {
            $.ajax({
                url: "{{url('/')}}/{{auth()->user()->account_type}}/delete_card_product",
                method: "POST",
                data: {
                    id: id
                },
    ...
    $('#add-video-submit').click(() => {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/add_card_video_link",
            method: "POST",
    ...
    $('#update-video-submit').click(() => {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/update_card_video_link",
            method: "POST",
            data: new FormData($('#videos_form')[0]),
            dataType: 'JSON',
            contentType: false,
    ...
    function edit_video(id) {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/get_card_video_link",
            method: "GET",
            data: {
                id: id
            },
    ...
    function delete_video(id) {
        if (confirm('Are you sure ? you want to delete the video')) {
            $.ajax({
                url: "{{url('/')}}/{{auth()->user()->account_type}}/delete_card_video",
                method: "POST",
                data: {
                    id: id
                },
    ...
    $('#add-image-submit').click(() => {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/add_card_gallery_image",
            method: "POST",
    ...
    $('#update-image-submit').click(() => {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/update_card_gallery_image",
            method: "POST",
            data: new FormData($('#images_form')[0]),
            dataType: 'JSON',
            contentType: false,
    ...
    function edit_image(id) {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/get_card_gallery_image",
            method: "GET",
            data: {
                id: id
            },
    ...
    function delete_image(id) {
        if (confirm('Are you sure ? you want to delete the image')) {
            $.ajax({
                url: "{{url('/')}}/{{auth()->user()->account_type}}/delete_card_gallery_image",
                method: "POST",
                data: {
                    id: id
                },
    ...
    $('#add-dc-submit').click(() => {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/add_card_dc",
            method: "POST",
    ...
    $('#update-dc-submit').click(() => {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/update_card_dc",
            method: "POST",
            data: new FormData($('#dc_form')[0]),
            dataType: 'JSON',
            contentType: false,
    ...
    function edit_attachment(id) {
        $.ajax({
            url: "{{url('/')}}/{{auth()->user()->account_type}}/get_card_dc",
            method: "GET",
            data: {
                id: id
            },
    ...
    function delete_attachment(id) {
        if (confirm('Are you sure ? you want to delete the attachment')) {
            $.ajax({
                url: "{{url('/')}}/{{auth()->user()->account_type}}/delete_card_dc",
                method: "POST",
                data: {
                    id: id
                },
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                if (data.status == 'Success') {
                    ...
                    var company_addresses_length = card_addresses.length;

                    if (company_addresses_length) {
                        var sno = 1;
                        ...
                        card_addresses.forEach(address => {
                            ...
                            if (company_addresses_length != 1) {
                                add_address();

                                company_addresses_length--;
                            }
                    ...
                    var gst_nos_length = card_gst_nos.length;
                    if (gst_nos_length) {
                        var sno = 1;
                    ...
                    if (card_details.card_type == 'premium') {

                        var card_videos = data.response.video_links;
                        var card_gallery_images = data.response.gallery_images;
                        var card_products = data.response.company_products;
                        var card_dcs = data.response.company_attachments;

                        if (card_videos.length) {
                            $('#attach_videos').html('');

                            card_videos.forEach(link => {
                                console.log(link);
                                
                                var youTubeLink = YouTubeGetID(link.link.toString());
                                console.log(youTubeLink);
                                
                                if (youTubeLink != null) {
                                    var item = '<div class="col-md-4"><div class="video" style="margin-top:20px;">';
                                    
                                    var ytVideo = '<iframe width="250" height="160" frameborder="0" src="https://www.youtube.com/embed/'+youTubeLink+'"></iframe>';

                                    item = item.concat(ytVideo);
                        ...
                        if (card_gallery_images.length) {
                            $('#attach_images').html('');

                            var item = '';
                            card_gallery_images.forEach(image => {
                        ...
                        if (card_dcs.length) {
                            ...
                            var item = '';
                            card_dcs.forEach(attachment => {

                                var asset = "{{asset('sources/assets/user_card/company_dcs/')}}";

                                item = item.concat('<div class="col-md-4">');
                                item = item.concat('<div class="video" style="margin-top:20px;width:100%;">');
                                item = item.concat('<div class="card"><a target="_blank" href="' + asset + '/' + attachment.dc_name + '">');
                        ...
                        if (card_products.length) {
                            $('#attach_products').html('');

                            var item = '';
                            card_products.forEach(product => {
