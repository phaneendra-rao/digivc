            ...
            <div class="page-wrapper">
                ...
                <div class="page-header card">
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-4">
                        <a href="{{url('/superadmin/preview')}}/{{$card_details['template']}}/{{$card_details['user_id']}}/{{$card_details['id']}}" target="_blank" class="btn btn-sm btn-primary float-right">Preveiw Card</a>
                        <br><br>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <input type="text" name="user_id" class="d-none" value="{{$card_details->user_id}}" readonly>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="date" name="expiry_on" id="expiry_on" class="form-control" placeholder="Expiry On">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
...
$('#add-video-submit').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/add_video_link')}}",
        method:"POST",
...
$('#update-video-submit').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/update_video_link')}}",
        method:"POST",
        data:new FormData($('#videos_form')[0]),
        dataType:'JSON',
        contentType: false,
...
$('#add-image-submit').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/add_gallery_image')}}",
        method:"POST",
...
$('#update-image-submit').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/update_gallery_image')}}",
        method:"POST",
        data:new FormData($('#images_form')[0]),
        dataType:'JSON',
        contentType: false,
...
$('#add-product-submit').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/add_product')}}",
        method:"POST",
...
$('#update-product-submit').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/update_product')}}",
        method:"POST",
        data:new FormData($('#products_form')[0]),
        dataType:'JSON',
        contentType: false,
...
$('#upload-result').on('click', function (ev) {
    $uploadCrop.croppie('result', {
        ...
        $.ajax({
            url: "/superadmin/change_user_card_company_logo",
            method: "POST",
...
$('#upload-profile-result').on('click', function (ev) {
    $uploadCrop.croppie('result', {
        ...
        $.ajax({
            url: "/superadmin/change_user_card_profile_dp",
            method: "POST",
            data: {"id":"{{$card_details->id}}","image":resp},
            beforeSend:()=>{
                $('#overlay').removeClass('d-none');
...
$('#delete_dp').click(()=>{
    Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url:"{{url('/superadmin/delete_user_card_company_logo')}}",
                    method:"POST",
...
$('#delete_profile_dp').click(()=>{
    Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url:"{{url('/superadmin/delete_user_card_profile_dp')}}",
                    method:"POST",
                    data:{id:"{{$card_details->id}}"},
                    beforeSend:()=>{
                        $('#overlay').removeClass('d-none');
...
$('#save_contact_person_info_btn').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/save_contact_person_info')}}",
        method:"POST",
...
$('#save_company_info_btn_top,#save_company_info_btn_bottom').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/save_company_info')}}",
        method:"POST",
...
$('#bank_details_save_btn').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/save_bank_details')}}",
        method:"POST",
...
$('#online_payments_save_btn').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/save_online_payments')}}",
        method:"POST",
...
$('#shareable_links_save_btn').click(()=>{
    $.ajax({
        url:"{{url('/superadmin/save_shareable_links')}}",
        method:"POST",
...
function get_card_details()
{
    ...
    $.ajax({
        url:"/superadmin/get_user_card_details",
        method:"GET",
...
{
    $.ajax({
        url:"{{url('/superadmin/get_video_link')}}",
        method:"GET",
        data:{id:id},
        beforeSend:()=>{
            $('#overlay').removeClass('d-none');
...
{
    $.ajax({
        url:"{{url('/superadmin/get_gallery_image')}}",
        method:"GET",
        data:{id:id},
        beforeSend:()=>{
            $('#overlay').removeClass('d-none');
...
{
    $.ajax({
        url:"{{url('/superadmin/get_product')}}",
        method:"GET",
        data:{id:id},
        beforeSend:()=>{
            $('#overlay').removeClass('d-none');
...
function delete_video(id)
{
    ...
    {
        $.ajax({
            url:"{{url('/superadmin/delete_video')}}",
            method:"POST",
            data:{id:id},
            beforeSend:()=>{
                $('#overlay').removeClass('d-none');
...
function delete_image(id)
{
    ...
    {
        $.ajax({
            url:"{{url('/superadmin/delete_gallery_image')}}",
            method:"POST",
            data:{id:id},
            beforeSend:()=>{
                $('#overlay').removeClass('d-none');
...
function delete_product(id)
{
    ...
    {
        $.ajax({
            url:"{{url('/superadmin/delete_product')}}",
            method:"POST",
            data:{id:id},
            beforeSend:()=>{
                $('#overlay').removeClass('d-none');
...
var messages_table = $('#messages_table').DataTable({
    ...
    serverSide: true,
    ajax: {
        url: "{{url('/superadmin/get_all_user_card_messages')}}",
        dataType: "json",
        type: "POST",
...
function delete_message(message_id)
{
    ...
    {
        $.ajax({
            url:"{{url('/superadmin/delete_card_message')}}",
            method:"POST",
            data:{id:message_id},
            beforeSend:()=>{
                $('#overlay').removeClass('d-none');
